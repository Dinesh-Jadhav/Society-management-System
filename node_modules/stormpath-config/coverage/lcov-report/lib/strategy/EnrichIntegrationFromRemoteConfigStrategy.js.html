...
<html lang="en">
<head>
    <title>Code coverage report for lib/strategy/EnrichIntegrationFromRemoteConfigStrategy.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/strategy/</a> EnrichIntegrationFromRemoteConfigStrategy.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.4% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>92/109</span>
      </div>
      <div class='fl pad1y space-right2'>
...
263
264
265</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!config.web.social) {
      config.web.social = {};
    }
&nbsp;
...
&nbsp;
        // Iterate directories
        <span class="missing-if-branch" title="else path not taken" >E</span>if (/\/directories/.test(accountStore.href)) {
...
&nbsp;
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if (['stormpath', 'ad', 'ldap'].indexOf(providerId) === -1) {
...
&nbsp;
              <span class="missing-if-branch" title="else path not taken" >E</span>if (!localProvider) {
                localProvider = config.web.social[providerId] = {};
              }
&nbsp;
              <span class="missing-if-branch" title="else path not taken" >E</span>if (!localProvider.uri) {
...
&nbsp;
              var localScope;
&nbsp;
              <span class="missing-if-branch" title="if path not taken" >I</span>if (localProvider.scope) {
<span class="cstat-no" title="statement not covered" >                localScope = localProvider.scope;</span>
              }
&nbsp;
              extend(remoteProvider, { enabled: true });
              extend(localProvider, remoteProvider);
&nbsp;
              <span class="missing-if-branch" title="if path not taken" >I</span>if (localScope) {
<span class="cstat-no" title="statement not covered" >                localProvider.scope = localScope;</span>
              }
&nbsp;
            }
&nbsp;
...
&nbsp;
    mappings.detect(<span class="fstat-no" title="function not covered" >function(mapping, detectCallback) {</span>
<span class="cstat-no" title="statement not covered" >      detectCallback(mapping.isDefaultAccountStore);</span>
    }, function(defaultMapping) {
      if (defaultMapping) {
        var href = defaultMapping.accountStore.href;
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (href.match(/directories/)) {
          return callback(null, href);
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (href.match(/group/)) {</span>
<span class="cstat-no" title="statement not covered" >          outerScope.client.getGroup(href, <span class="fstat-no" title="function not covered" >function(err, group) {</span></span>
<span class="cstat-no" title="statement not covered" >            return callback(err, group &amp;&amp; group.directory.href);</span>
          });
        } else {
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (config.application &amp;&amp; config.application.href) {
    tasks = tasks.concat([
