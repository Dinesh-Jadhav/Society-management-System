...
&nbsp;
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.extendWith) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if(extendWith.requestExecutor){
