...
<span class="cstat-no" title="statement not covered" >  return new ApiAuthRequestError({</span>
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (!jwt.header.kid) {
...
<span class="cstat-no" title="statement not covered" >        return authenticator.authenticate(cb);</span>
      }
&nbsp;
