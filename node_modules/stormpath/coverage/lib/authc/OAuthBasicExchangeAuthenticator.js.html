...
<span class="cstat-no" title="statement not covered" >      return callback(err.status === 404 ? new ApiAuthRequestError({userMessage: 'Invalid Client Credentials', error: 'invalid_client', statusCode: 401}) : err);</span>
    }
&nbsp;
    if (
