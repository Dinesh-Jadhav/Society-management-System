...
520
521
522</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cstat-no" title="statement not covered" >      return _request;</span>
    },
    set: function (value) {
      _request = value;
    }
...
&nbsp;
DataStore.prototype._wrapGetResourceResponse = function wrapGetResourceResponse(err, data, InstanceCtor, query, cb) {
  var _this = this;
  if (err) {
    return cb(err, null);
  }
  ...
  } else if (utils.isCollectionData(instance) &amp;&amp; instance.items[0] &amp;&amp; instance.items[0] instanceof ApiKey) {
