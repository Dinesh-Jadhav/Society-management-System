...
var socialApp = angular.module('socialApp', ['ngRoute', 'datatables', 'datatables.buttons', 'ngFileUpload', 'ngImgCrop', 'ui.bootstrap', 'googlechart', 'angular-hmac-sha512','luegg.directives']);
...
socialApp.config(function($routeProvider, $crypthmacProvider, $httpProvider) {
    ...
    $routeProvider.when('/admin-login', {
        ...
        activetab: 'managers',
        title: 'Edit Manager | Admin'
    }).when('/view-manager/:id', {
        controller: 'viewManager',
        templateUrl: 'admin/admin-panel/html/view-manager.html',
        activetab: 'managers',
        title: 'View Manager | Admin'
    }).when('/block-list/:id', {
    ...
    }).when('/resident-service-info-details/:residentID', {
        templateUrl: 'admin/admin-panel/html/resident-service.html',
        controller: 'residentServiceInfo',
        activetab: 'residetns',
        title: 'Resident Details | Admin'
    }).when('/add-service', {
        controller: 'service',
    ...
    }).when('/edit-society/:id', {
        controller: 'editSociety',
        templateUrl: 'admin/admin-panel/html/edit-society.html',
        activetab: 'society',
        title: 'Edit Society | Admin'
    }).when('/handler', {
        controller: 'addHandler',
        templateUrl: 'admin/admin-panel/html/handler.html',
        activetab: 'society',
        title: 'Handler | Admin'
    }).when('/home-list', {
        controller: 'homeserviceList',
    ...
    $routeProvider.when('/service-admin-login', {
        controller: 'servicelogin',
        templateUrl: 'serviceadmin/login/login.html',
        title: 'Login | Service Admin'
    }).when('/admin-service-list', {
        controller: 'serviceList',
        templateUrl: 'serviceadmin/html/service-list.html',
        activetab: 'Service',
        title: 'All Services Request | Service Admin'
    }).when('/home-service-list', {
        controller: 'homeserviceList',
        templateUrl: 'serviceadmin/html/home-service-list.html',
        activetab: 'Service',
        title: 'Home Services Request | Service Admin'
    }).when('/service-all', {
        controller: 'serviceAll',
    ...
    }).when('/request-for-service/:blockID', {
        controller: 'requestService',
        templateUrl: 'society/html/request-for-service.html',
        activetab: 'Servent',
        title: "Request For Service | Manager"
    }).when('/view-services/:blockID', {
        controller: 'Serviceall',
        templateUrl: 'society/html/view-service.html',
        activetab: 'Servent',
        title: "Request For Servent | Manager"
    }).when('/adhoc-expense/:blockID', {
        controller: 'adhocExpense',
        templateUrl: 'society/html/adhoc-expense.html',
        activetab: 'MoneyManager',
        title: "Adhoc Expenses | Manager"
    }).when('/maintainance_category/:blockID', {
        controller: 'mainCategory',
        templateUrl: 'society/html/maintainance_category.html',
        activetab: 'JobCard',
        title: "Maintainance Category | Manager"
    }).when('/defaulter-list/:blockID', {
        controller: 'defaulterList',
        templateUrl: 'society/html/defaulter-list.html',
        title: "Maintainance Category | Manager"
    }).when('/add_staff_for/:blockID', {
        controller: 'staffFor',
        templateUrl: 'society/html/add_staff_for.html',
        activetab:'Staff',
